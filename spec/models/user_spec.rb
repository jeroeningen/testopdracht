...
describe User do
  describe "given an empty user" do
  ...
  describe "given an valid zipcode" do
  ...
  describe "given an invalid zipcode" do
  ...
  describe "given an valid user" do
  ...
  describe "given a user with a firstname and lastname" do
